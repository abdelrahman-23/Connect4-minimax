...
public class Board {
	...
	public int getScore(String playerType,int depth,int maxDepth) {
		...
		String opponentType = (Objects.equals(playerType, "AI")) ? "Human" : "AI";
	...
	public int setPlayer(String playerType) {
		if (Objects.equals(playerType, "Ai") || Objects.equals(playerType, "AI")){
			return 1;
		} else if (Objects.equals(playerType, "Human") || Objects.equals(playerType, "human")){
			return 2;
		} 
		return 0;
	}
	...
	public int calculateScore(int countPlayer, int countEmpty, int countOpponent,String playerType, String opponent, int depth, int maxDepth) {
		...
		if (countPlayer == 4 && !this.isBoardFull()) { // player has line of four
			...
			score += 2;
		} else if (countPlayer == 1 && countEmpty == 3) { // player has line of two
			score += 1;
		}
		...
		}  else if (countOpponent == 1 && countEmpty == 3) { // player has line of two
			score -= 1;
		}
